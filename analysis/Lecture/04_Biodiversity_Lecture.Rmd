...
knitr::opts_chunk$set(echo = TRUE, 
                      fig.path = "../figures/Lecture/05_Biodiversity_Lecture/")
```
...
1. We will need the `preprocessed_physeq`, which includes a rooted tree (ideally within the archaea!) that we created in `analysis/04B_Phylogenetic_Tree_Inspection.Rmd`. 
